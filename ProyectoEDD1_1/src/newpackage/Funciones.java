    ...
    public ListaSimple Leer_txt(String path){
        ...
        try{
            if (!file.exists()) {
                ...
                JOptionPane.showMessageDialog(null, lista.getpFirst().getweight());
                br.close();
            } 
        }
     ...
     public void Leer_matrix(String path){
        String line;
        String infotd = "";
        File file = new File(path);
        ...
        try{
            if (!file.exists()) {
                ...
                if(!"".equals(infotd)){
                    ...
                    for(int i = 0;i< infos.length -1;i++){
                        ...
                        for(int j = 0;j< low.length-1;j++){
                            JOptionPane.showMessageDialog(null, low[j]);
                        }
                ...
                br.close();
                JOptionPane.showMessageDialog(null, infotd);
